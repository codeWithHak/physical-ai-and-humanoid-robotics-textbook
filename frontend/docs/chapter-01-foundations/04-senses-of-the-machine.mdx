...
graph LR
    ...
    IR -->|Projects dot pattern| Scene[Scene/Object]
    Scene -->|Reflected pattern| L
    Scene -->|Reflected pattern| R
    L -->|Image A| VP[Vision Processor]
    R -->|Image B| VP
    VP -->|Disparity Calculation| Depth[Depth Map]

    style Depth fill:#BFE600,stroke:#000,color:#000
```

<Admonition type="tip" title="How Stereo Depth Works">
