---
title: "The Hardware Nervous System"
sidebar_position: 3
---
...
<Mermaid>
  {`
graph TD
    subgraph "Digital Twin Workstation (PC)"
        direction LR
        CPU[CPU]
        RAM[64GB+ RAM]
        GPU[RTX 4070 Ti+]
    ...
    subgraph "Physical Robot"
        direction LR
        Edge[Edge Brain<br/>(Jetson Orin)]
        Sensors[Sensors]
        Motors[Motors]
    end

    Workstation -- "Model Training & Simulation" --> Sim[Isaac Sim]
